...
public class AccountController {
    ...
    public ResponseEntity updateAccount(@RequestBody AccountDto accountDto) {
        ...
        if (accountDto.getName().equals("") || accountDto.getEmail().equals("") || accountDto.getPhone().equals("")) {
    ...
    @ResponseBody
    public AccountDto updateAccountViaUser() {
    ...
    public ResponseEntity saveAccountUpdateViaUser(@RequestBody AccountDto accountDto) {
        ...
        if (accountDto.getName().equals("") || accountDto.getEmail().equals("") || accountDto.getPhone().equals("")) {
            ...
            List<Account> account = accountRepository.findAccountByEmailOrPhone(accountDto.getEmail(), accountDto.getPhone());
            if (account.size() == 1) {
                accountDto.setRole(Roles.ROLE_USER.name());
                AccountDto updateAccount = accountService.updateAccount(accountDto);
