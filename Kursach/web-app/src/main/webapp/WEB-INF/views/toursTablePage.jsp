            ...
            <form id="addForm">
                ...
                <div class="form-label-group" id="type">
                    <select id="types" class="mdb-select md-form">
                        ...
                        <option value="LAST_OFFER_TOUR"><spring:message code="lastMinuteTour.label"/></option>
                    </select>
                </div>
                ...
                <a href="/showTours" class="btn btn-primary btn-block" id="saveTourBtn"
                   type="button" onclick="save();return false;"><spring:message code="save.button"/>
                </a>
            </form>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form id="deleteForm">
                    ...
                    <button class="btn  btn-primary" id="deleteBtn"
                            onclick="deleteRecord($('#idDeleteTour').val());deleteFormHide();"
