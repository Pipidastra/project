    ...
    <div id="tours">
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $.get("/tour?type=LAST_OFFER_TOUR", function (data) {
                    var rowsHtml;
                    for (var j = 0; j < data.length; j = j + 3) {
                        ...
                        rowsHtml += "<p><span class='glyphicon glyphicon-time' ></span><b> " + data[j].numberDays + "</b></p>";
                        ...
                        if (j + 1 < data.length) {
                            ...
                            rowsHtml += "<p> Дата выезда:<b>" + exitDate + "</b><p>";
                            rowsHtml += "<p><span class='glyphicon glyphicon-time' ></span><b> " + data[j + 1].numberDays + "</b></p>";
                        ...
                        if (j + 2 < data.length) {
                            ...
                            rowsHtml += "<p> Дата выезда:<b>" + exitDate + "</b><p>";
                            rowsHtml += "<p><span class='glyphicon glyphicon-time' ></span><b> " + data[j + 2].numberDays + "</b></p>";
