        ...
        <div>
            ...
            <div class="modal-body">
                <form id="ReserveForm">
                    ...
                    <div class="form-label-group">
                        <input type="number" id="numberPersons" class="form-control" placeholder="Number persons"
                               required autofocus>
                    </div>
                    <div id="mistake"></div>
        ...
        <section class="container">
            <div class="panel-body">
                ...
                <c:if test="${tour.rating != -1}">
                    <h2><div class="starrr disabled stars-existing" data-rating=${tour.rating}></div></h2>
                </c:if>
                <c:if test="${tour.rating == -1}">
                    <h3><div><spring:message code="rating.error"/></div></h3>
                </c:if>
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div id="saveCommentMistake" hidden><p class='alert alert-danger' role='alert'><spring:message code="saveComment.error"/></p></div>
